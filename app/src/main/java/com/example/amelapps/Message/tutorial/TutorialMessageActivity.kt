package com.example.amelapps.Message.tutorial
...
import com.example.amelapps.databinding.ActivityTutorialMessageBinding
...
class TutorialMessageActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val fragmentsList =
            listOf(Tutorial1Fragment(), Tutorial2Fragment(), Tutorial3Fragment())
